...
const addToCart = () =>{
  ...
  return (
    ...
    <div  key={props._id} className="w-80 lg:w-72 m-auto my-4 grid grid-rows-8 shadow-lg shadow-black" style={{
            ...
            <div className="row-span-2">
                <button className="btn m-3 shadow-lg  bg-slate-700 " type="button" onClick={addToCart}>Update</button>
            </div>
        </div>
{/*
